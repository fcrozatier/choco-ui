...
<h2>Math</h2>
<p>Here is a math formula $c^2 = a^2 + b^2$</p>
<p>You can use a <code>math</code> code block</p>
<pre><code class="language-math">L = \frac{1}{2} \rho v^2 S C_L
</code></pre>
<p>Or a Latex display block with <code>$$</code></p>
<p>$$
